...
class Year2InjurySuccessorCutoverContractTests(unittest.TestCase):
    ...
    def test_exact_private_successor_and_registration_are_bound(self) -> None:
        self.assertEqual(
            ...
            "06572c701bf99f2dc669c4c27feecb80bca69d0ed756d47b67a14ec4c8367187",
        )
        for value in (
            ...
            "migration_sha256=06572c701bf99f2dc669c4c27feecb80bca69d0ed756d47b67a14ec4c8367187",
        ):
    ...
    def test_registration_checks_live_privacy_and_candidate_completeness(self) -> None:
        ...
        self.assertEqual(
            self.registration.count("migration_sha256=06572c701bf99f2dc669c4c27feecb80bca69d0ed756d47b67a14ec4c8367187"),
            2,
        )

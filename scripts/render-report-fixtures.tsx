...
const source = `
  ...
  for (let index = 0; index < fixtures.length; index += 1) {
    ...
    const model = buildReportModel({ current, prior, expectedScope: fixture.scope, expectedSeason: current.season, subjectName: fixture.subjectName, protectedTerms: denylist, exportedAt: "2026-08-31T12:00:00Z", comparisonRows, comparisonBenchmarks, brand: { crestDataUri, accentColour: fixture.accentColour } });

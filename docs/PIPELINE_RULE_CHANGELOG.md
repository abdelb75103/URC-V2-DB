...
| Field | Value |
|---|---|
| Status | Base capability and additive T4 hardening `live-installed-and-verified`; renewed independent `sol_xhigh` T4 acceptance passed with no P0, P1 or P2 blockers. No sample correction was retained or promoted. |

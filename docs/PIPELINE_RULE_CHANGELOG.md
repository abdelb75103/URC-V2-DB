...
| Migration | Additive successor `20260902010000_urc_hsr_reporting_v8.sql`, SHA-256 `46ba9e9f5d5fa0f3a01e8e3c2330984e418cbc15d2412089c7a2b145031e3b78`; checksum registration `tools/sql/register_urc_hsr_reporting_v8_migration.sql`; read-only proof `tools/sql/verify_hsr_reporting_v8.sql`. |
